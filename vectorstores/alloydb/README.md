...
See the full [Vector Store example and tutorial](https://github.com/Presslogic-Media/langchaingo/tree/main/examples/google-alloydb-vectorstore-example).
...
import (
  ...
  "github.com/Presslogic-Media/langchaingo/vectorstores/alloydb"
)
