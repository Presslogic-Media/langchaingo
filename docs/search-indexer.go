...
func parseFlags() Config {
	...
	flag.StringVar(&config.PkgGoDevURL, "pkg-url", "https://pkg.go.dev/github.com/Presslogic-Media/langchaingo", "pkg.go.dev base URL")
	flag.StringVar(&config.ModulePath, "module", "github.com/Presslogic-Media/langchaingo", "Go module path")
