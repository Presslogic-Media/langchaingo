...
```shell
go run github.com/Presslogic-Media/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-completion-example](https://github.com/Presslogic-Media/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
